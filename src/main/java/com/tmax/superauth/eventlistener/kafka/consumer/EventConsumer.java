package com.tmax.superauth.eventlistener.kafka.consumer;

import com.google.gson.Gson;
import com.tmax.superauth.eventlistener.TopicEvent;
...
//    private static final String BOOTSTRAP_SERVERS_INTERNAL = "kafka-1.superauth:9092,kafka-2.superauth:9092,kafka-3.superauth:9092"; // superauth 떠 있는 Kubernetes Cluster 내부에서 Subscribe 하는 경우 사용
    private final static String BOOTSTRAP_SERVER_EXTERNAL = "dev-kafka1.tmaxoneaccount.com:9093,dev-kafka2.tmaxoneaccount.com:9093,dev-kafka3.tmaxoneaccount.com:9093"; // superauth 떠 있는 Kubernetes Cluster 외부에서 Subscribe하는 경우 dev-kafka1.tmaxoneaccount.com:9093 등을 상황에 맞게 바꾸어서 사용한다.

    // kafka broker 3개가 노출되어 있는 주소는 superauth, kafka 관리자에게 문의해서 추가한다.
    ...
    public static void main(String[] args) {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "hypercloud");   // TODO: Change group id to your Superauth client Name
