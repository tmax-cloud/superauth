 ...
 */
@Slf4j
public class SuperauthEventListenerProviderFactory implements EventListenerProviderFactory {
    @Override
    public EventListenerProvider create(KeycloakSession keycloakSession) {
        return new SuperauthEventListenerProvider(keycloakSession);
    }
...
//                    .withSchedule(CronScheduleBuilder.cronSchedule( "*/30 * * * * ?" )) // For test every 30 sec
    ...
    @Override
    public String getId() {
        return "superauth_event_listener";
    }
}
