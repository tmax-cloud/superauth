package com.tmax.superauth.authenticator.passwordUpdateAlert;

import com.tmax.superauth.authenticator.AuthenticatorConstants;
import com.tmax.superauth.authenticator.AuthenticatorUtil;
import com.tmax.superauth.caller.StringUtil;
...
public class PasswordUpdateAlertAuthenticator implements Authenticator {
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        if (!isUserHasPasswordCredential(context)){
            log.info("User [ " + context.getUser().getUsername() + " ] Has no Password Credential in superauth, Do Not Need to Update Password");
            context.success();
            return;
        }
